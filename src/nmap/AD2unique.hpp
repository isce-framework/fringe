#ifndef FRINGE_AD2UNIQUE_H
#define FRINGE_AD2UNIQUE_H
...
struct AD2unique
{
    ...
    const double ts[280] ={ -1.1954, -1.5806, -1.8172, 
      ...
      // p values bins 
    const double prob[35] = { .00001,.00005,.0001,.0005,.001,.005,.01,.025,.05,.075,.1,.2,.3,.4,.5,.6,.7,.8,.9,
